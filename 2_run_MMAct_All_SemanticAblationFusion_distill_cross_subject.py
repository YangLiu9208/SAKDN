...
parser.add_argument('--acc_phone_train_path', type=str, default=r"E:/Multi-modal Action Recognition/MMAct_sensors/acc_phone_cross_subject_train/")
parser.add_argument('--acc_phone_test_path', type=str, default=r"E:/Multi-modal Action Recognition/MMAct_sensors/acc_phone_cross_subject_test/")
parser.add_argument('--acc_watch_train_path', type=str, default=r"E:/Multi-modal Action Recognition/MMAct_sensors/acc_watch_cross_subject_train/")
parser.add_argument('--acc_watch_test_path', type=str, default=r"E:/Multi-modal Action Recognition/MMAct_sensors/acc_watch_cross_subject_test/")
parser.add_argument('--gyro_train_path', type=str, default=r"E:/Multi-modal Action Recognition/MMAct_sensors/gyro_cross_subject_train/")
parser.add_argument('--gyro_test_path', type=str, default=r"E:/Multi-modal Action Recognition/MMAct_sensors/gyro_cross_subject_test/")
parser.add_argument('--orientation_train_path', type=str, default=r"E:/Multi-modal Action Recognition/MMAct_sensors/orientation_cross_subject_train/")
parser.add_argument('--orientation_test_path', type=str, default=r"E:/Multi-modal Action Recognition/MMAct_sensors/orientation_cross_subject_test/")
parser.add_argument('--stu_video_train_path', type=str, default=r"data/MMAct_cross_subject_train_list.txt")
parser.add_argument('--stu_video_test_path', type=str, default=r"data/MMAct_cross_subject_val_list.txt")
...
opts.dataset='MMAct_Cross_Subject_AblationCAM'
...
opts.teacher_load='output/MMAct_cross_subject_a_g_o_SemanticFusionVGG16_MMAct_margin0.2_epochs70_batch16_lr0.0001/gyro_best_acc.pth'
#opts.load='output/MMAct_Cross_Subject_AblationCAM_a_g_o_v_teacher_SemanticFusionVGG16_MMAct_student_TRN_arch_BNInception_seg8_epochs60_batch16_lr0.001_st0.1_se1_dropout0.8/best_acc.pth'
...
def main():
    ...
    def train(ap_loader, aw_loader, gyro_loader, ori_loader,s_loader,ep):
        ...
        #for (ap_images, ap_labels),(aw_images, aw_labels), (gyro_images, gyro_labels),(ori_images, ori_labels),(s_videos,s_labels) in zip(cycle(ap_loader),cycle(aw_loader),cycle(gyro_loader),cycle(ori_loader),s_loader):
            ...
            #w_aw=(soft_ap_semantic[0:t_side,:]-soft_ap_semantic[t_side:,:]).div(soft_ap_semantic[0:t_side,:]).cpu().data.numpy()
            #w_ap=(soft_aw_semantic[0:t_side,:]-soft_aw_semantic[t_side:,:]).div(soft_aw_semantic[0:t_side,:]).cpu().data.numpy()
            #w_gy=(soft_gy_semantic[0:t_side,:]-soft_gy_semantic[t_side:,:]).div(soft_gy_semantic[0:t_side,:]).cpu().data.numpy()
            #w_ori=(soft_ori_semantic[0:t_side,:]-soft_ori_semantic[t_side:,:]).div(soft_ori_semantic[0:t_side,:]).cpu().data.numpy()
            ...
            ablation_cam_v_semantic /= (np.max(ablation_cam_v_semantic)+eps)           
