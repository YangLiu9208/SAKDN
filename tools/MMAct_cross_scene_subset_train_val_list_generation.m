...
fid=fopen('MMAct_cross_scene_1_8_train_list.txt','w');%写入文件路径
fid2=fopen('MMAct_cross_scene_1_8_val_list.txt','w');%写入文件路径
        ...
        for k=1:length(Inertial_data_session_dir)
            ...
            for p=1:length(data_dir)
                ...
                for m=1:length(each_vid_data_dir)
                    ...
                    if ~isempty(strfind(cell2mat(Inertial_data_session_dir(k)),'scene1')) ||~isempty(strfind(cell2mat(Inertial_data_session_dir(k)),'scene3')) || ~isempty(strfind(cell2mat(Inertial_data_session_dir(k)),'scene4'))
...
if contains(cell2mat(each_vid_data_dir(m)),'carrying')&&~contains(cell2mat(each_vid_data_dir(m)),'carrying_heavy')&&~contains(cell2mat(each_vid_data_dir(m)),'carrying_light')
                    ...
                    if ~isempty(strfind(cell2mat(Inertial_data_session_dir(k)),'scene2'))
