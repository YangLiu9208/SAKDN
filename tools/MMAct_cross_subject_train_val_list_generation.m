...
fid=fopen('MMAct_cross_subject_half_train_list.txt','w');%写入文件路径
fid2=fopen('MMAct_cross_subject_half_val_list.txt','w');%写入文件路径
        ...
        for k=1:length(Inertial_data_session_dir)
            ...
            for p=1:length(data_dir)
                ...
                for m=1:length(each_vid_data_dir)
                    ...
                    if ~isempty(strfind(cell2mat(vid_data_dir(i)),'subject01')) ||~isempty(strfind(cell2mat(vid_data_dir(i)),'subject02')) || ~isempty(strfind(cell2mat(vid_data_dir(i)),'subject03')) || ~isempty(strfind(cell2mat(vid_data_dir(i)),'subject04')) ...
                            ||~isempty(strfind(cell2mat(vid_data_dir(i)),'subject05')) || ~isempty(strfind(cell2mat(vid_data_dir(i)),'subject06')) || ~isempty(strfind(cell2mat(vid_data_dir(i)),'subject07')) ...
                            ||~isempty(strfind(cell2mat(vid_data_dir(i)),'subject08')) || ~isempty(strfind(cell2mat(vid_data_dir(i)),'subject09')) || ~isempty(strfind(cell2mat(vid_data_dir(i)),'subject10')) ...
                            ||~isempty(strfind(cell2mat(vid_data_dir(i)),'subject11')) || ~isempty(strfind(cell2mat(vid_data_dir(i)),'subject12')) || ~isempty(strfind(cell2mat(vid_data_dir(i)),'subject13')) ...
                            ||~isempty(strfind(cell2mat(vid_data_dir(i)),'subject14')) || ~isempty(strfind(cell2mat(vid_data_dir(i)),'subject15')) || ~isempty(strfind(cell2mat(vid_data_dir(i)),'subject16'))
                    ...
                    if ~isempty(strfind(cell2mat(vid_data_dir(i)),'subject17')) ||~isempty(strfind(cell2mat(vid_data_dir(i)),'subject18')) || ~isempty(strfind(cell2mat(vid_data_dir(i)),'subject19')) || ~isempty(strfind(cell2mat(vid_data_dir(i)),'subject20')) 
