...
fid=fopen('UTD_rgb_train_list_subject_specific.txt','w');%写入文件路径
fid2=fopen('UTD_rgb_val_list_subject_specific.txt','w');%写入文件路径
...
for i=1:length(vid_data_dir)
    ...
    if ~isempty(strfind(cell2mat(vid_data_dir(i)),'t1')) ||~isempty(strfind(cell2mat(vid_data_dir(i)),'t2')) 
    ...
    if ~isempty(strfind(cell2mat(vid_data_dir(i)),'t3')) ||~isempty(strfind(cell2mat(vid_data_dir(i)),'t4')) 
        if ~isempty(strfind(cell2mat(vid_data_dir(i)),'a1'))
            action_class=0;
        end
        if ~isempty(strfind(cell2mat(vid_data_dir(i)),'a2'))
