...
parser.add_argument('--stu_video_train_path', type=str, default=r"data/MMAct_cross_scene_train_list.txt")
parser.add_argument('--stu_video_test_path', type=str, default=r"data/MMAct_cross_scene_val_list.txt")
...
opts.dataset='MMAct_Cross_Scene_AblationCAM'
...
opts.teacher_load='output/MMAct_cross_scene_a_g_o_SemanticFusionVGG16_MMAct_margin0.2_epochs70_batch16_lr0.0001/aw_best_acc.pth'
