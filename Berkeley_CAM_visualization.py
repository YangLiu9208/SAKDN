...
opts.load='save_results/Berkeley_6a_v_teacher_SemanticFusionVGG16_Berkeley_student_TRN_arch_BNInception_seg8_epochs20_batch8_lr0.001_dropout0.8/best_acc.pth'
...
def save_image(image,index,label):
    ...
    io.imsave(os.path.join('Berkeley_visualization', '{}_class{}.jpg'.format(index,label)), image)
